  ...
  return (
    <section className="bg-[#1a3329] px-4 py-24 md:px-8 md:py-32">
      <div className="mx-auto max-w-4xl text-center">
        <FadeIn>
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#d4b87a]">
            Premium Living
          </p>
        ...
        <FadeIn delay={0.12} className="mt-10">
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Link
              href="/contact"
              className="group inline-flex items-center justify-center gap-2 rounded-full border border-[#d4b87a]/50 bg-[#d4b87a] px-10 py-4 text-sm font-semibold text-[#1a1a1a] shadow-lg shadow-black/20 transition-colors hover:bg-[#e0c78f] md:text-base"
            >
              상담 문의하기
